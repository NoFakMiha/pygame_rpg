...
class Player(pygame.sprite.Sprite):
    def __init__(self, game,x, y):
        ...
        self.game = game
        self._layer = PLAYER_LAYER # setting the layer of the sprites
    ...
    def colide_enemy(self):
        enenmy_hits = pygame.sprite.spritecollide(self, self.game.enemies, False)
        if enenmy_hits:
            self.kill()
...
class Enemy(pygame.sprite.Sprite):
    ...
    def movment(self):
        if self.facing == 'left':
            ...
            self.movment_loop -= 1
            if self.movment_loop <= -self.max_travel:
                self.facing = 'right'
...
class Block(pygame.sprite.Sprite):
    def __init__(self, game,x, y):
        ...
        self.groups = self.game.all_sprites, self.game.blocks # testing colision
        pygame.sprite.Sprite.__init__(self, self.groups)
...
class Gorund(pygame.sprite.Sprite):
    def __init__(self,game,x,y):
        self.game = game
